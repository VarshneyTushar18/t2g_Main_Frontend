...
import { FaFacebook, FaFacebookSquare, FaInstagram, FaInstagramSquare, FaLinkedin, FaTwitterSquare } from "react-icons/fa";
...
export default function SocialMediaMarketing() {
  ...
  return (
    <>
      ...
      <Breadcrumb parentName="Services" pageName="Social Media Marketing" />
      <BrandSection />
      <section className={Style.PageContent}>
        <div className="container">
          <div className="row">
            <div className="col-lg-9 col-md-9 col-sm-12 col-xs-12">
              <ServiceBanner pageName="Social Media Marketing" imageSrc="/images/services/service-inner/digital-marketing-banner1.jpg" />
              <div className={Style.ContentDiv}>
                <p>The advertising business has significantly benefited from social media marketing (SMM), opening a whole new universe of chances for marketers and audiences to engage. SMO entails reaching out to your audience using social media sites like Facebook, Twitter, LinkedIn, Pinterest, blogs, RSS feeds, social news sites, and other platforms. The most cost-effective strategy is to maintain a two-way communication with your current and potential clients.</p>

                <p>Social media not only gives you a worldwide reach, but it also aids in increasing exposure, widening brand coverage, driving traffic, leads, and conversions, and most significantly, increasing audience engagement. Thanks to the ability of "word of mouth," social networking sites are more compelling than anything else!</p>

                <p>With the aid of a Social Media Marketing Company, you can develop a dynamic, data-driven social media marketing plan that will help your company achieve extraordinary results and turn consumers into brand ambassadors. More importantly, a unique social media marketing strategy may help your company's SEO and digital marketing efforts, resulting in more leads and revenue.</p>

                <p>Tech2Globe is a well-known Social Media Marketing Agency in India with an expert team of social media marketing professionals! Our social media marketing specialists discuss the different aspects of business-to-consumer (B2C) and business-to-business (B2B) social media marketing to help you get started with your campaign.</p>
              </div>

              <div className={Style.ContentDiv}>
                <h4 className="text-danger">Advantages Of Using Social Media Marketing Services</h4>
                <p>For both new and old businesses, Social Media Marketing Services provide extensive benefits. SMM may lead to more search traffic, healthier consumer interaction, better SEO, and enhanced brand loyalty.</p>
                <p>Are you still unsure about hiring a Social Media Marketing Agency? We bring you the most crucial advantages of SMM to help you make your decision -</p>

                <div className={`${Style.PageAccordion} accordion mn-3`} id="accordionSection1">
                    ...
                    >
                      <div className={`${Style.AccordionBody} accordion-body`}>
                        <p className="para-text">
                          Social media marketing is continually changing and expanding, and it is swiftly establishing itself as an effective online marketing tool for businesses and brands. Social media networks may help your firm get visibility and interest in a dynamic way. With a successful social media content marketing plan, you can produce more interactions and social signals, such as likes and shares, to help you communicate with a broader online audience.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={`${Style.AccordionItem} accordion-item`}>
                    ...
                    >
                      <div className={`${Style.AccordionBody} accordion-body`}>
                        <p className="para-text">
                          Bing and Google have begun to incorporate Tweets, updates, profiles, and comments into their SERPs, realizing the significance of social engagement. So, the more people share your material on social media, the more visitors your website will receive and the higher your search results will become.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={`${Style.AccordionItem} accordion-item`}>
                    ...
                    >
                      <div className={`${Style.AccordionBody} accordion-body`}>
                        <p className="para-text">
                          No matter how fantastic or exciting your material is, it won't result in conversions if it doesn't reach the right audience. You may use social media marketing to find and categorize your potential consumers based on their age, location, and online activities, among other things.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={`${Style.AccordionItem} accordion-item`}>
                    ...
                    >
                      <div className={`${Style.AccordionBody} accordion-body`}>
                        <p className="para-text">
                          Social media marketing packages are tailored to your needs and budget. It means you have total control over your branding, budget, and content marketing approach on social media.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={`${Style.AccordionItem} accordion-item`}>
                    ...
                    >
                      <div className={`${Style.AccordionBody} accordion-body`}>
                        <p className="para-text">
                          Small companies and giant corporations may benefit from social media marketing since it is a low-cost strategy to reach out to their target customers. You may use various social media sites to promote your products and services for a reasonable cost.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className={Style.ContentDiv}>
                <h4 className="text-danger">Our Social Media Marketing Services</h4>
                <p>Our social media promotion service is available for any of the social media sites listed below:</p>
                <div className="row">
                  <div className="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                    <FaFacebookSquare className={Style.IcoSmm} />
                  </div>
                  <div className="col-lg-11 col-md-11 col-sm-12 col-xs-12">
                    <p>With over a billion monthly active users, you can be confident that you'll reach your target demographic on Facebook. Expand your brand by using the most popular social media network.</p>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                    <FaInstagramSquare className={Style.IcoSmm} />
                  </div>
                  <div className="col-lg-11 col-md-11 col-sm-12 col-xs-12">
                    <p>Use one of the most engaging social media sites to find new items, which is used by over 60% of people globally. Begin constructing your audience right now.</p>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                    <FaTwitterSquare className={Style.IcoSmm} />
                  </div>
                  <div className="col-lg-11 col-md-11 col-sm-12 col-xs-12">
                    <p>Use one of the most engaging social media sites to find new items, which is used by over 60% of people globally. Begin constructing your audience right now.</p>
                  </div>
                ...
                <div className="row">
                  <div className="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                    <FaLinkedin className={Style.IcoSmm} />
                  </div>
                  <div className="col-lg-11 col-md-11 col-sm-12 col-xs-12">
                    <p>Use one of the most engaging social media sites to find new items, which is used by over 60% of people globally. Begin constructing your audience right now.</p>
                  </div>
              ...
              <div className={Style.ContentDiv}>
                ...
                <p>Tech2Globe maintains complete transparency as an award-winning <strong>YouTubeSocial Media Marketing company in India</strong>, so you can see firsthand how our efforts improve your online revenue. Our dedication to successful social media management and marketing tactics has resulted in a significant network resource for your online marketing requirements. Our <strong>Social Media Marketing & Advertising Agency</strong> can assist you in combining blog maintenance and content marketing with quality-driven SEO-free content marketing as part of our <strong>Social Media Marketing Services.</strong></p>
              </div>
