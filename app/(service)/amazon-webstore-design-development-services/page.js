...
export const metadata = {
  title: "Amazon webstore design and development services at tech2globe",
  description:
    "We possess years of experience in the field of helping ecommerce platforms and we are here to help you with designing and implementing of Amazon’s webstore.",
  keywords: [
    "amazon webstore design",
    "amazon store developer",
    "amazon webstore development",
    "amazon store design",
    "amazon webstores",
    "Amazon Store design & development",
    "Amazon Store Page Design",
  ...
  twitter: {
    ...
    title: "IT staffing services | IT staffing solutions",
    description:
      "Try our staffing services to identify and hire employee who meet the specific needs of your organization. Tech2Globe is here to help you address your staffing needs"
  }
};
...
const pageHeaderData = {
  title: "Amazon Webstore Design and Development",
...
export default function AmazonWebstoreDesignDevelopment() {
  return (

    <>
      <PageHeader pageHeaderData={pageHeaderData} />
      <Breadcrumb parentName="Services" pageName="Amazon Webstore Design Development Services" />
      <BrandSection />
      <section className={Style.PageContent}>
        <div className="container">
          <div className="row">
            <div className="col-lg-9 col-md-9 col-sm-12 col-xs-12">
              <ServiceBanner pageName="Amazon Webstore Design Development Services" imageSrc="/images/services/service-inner/amazon-virtual-assistant-top-banner2.jpg" />
              <div className={Style.ContentDiv}>
                <p>You can now get an access to an exclusive ecommerce store with other added assistances like maintenance, assortment and proficiency of Amazon through Amazon Webstore platform. Whenever your customers are searching for your products your Amazon Webstore will always be available for them, therefore you need not worry about that at all. Following are the added advantages provided to Amazon’s ecommerce stores:</p>
                <p>Amazon’s transaction system can handle the processing of the orders. There is no need of any other technical software for this purpose. Login details can be used by all the Amazon customers to have an access of the Amazon web store.You can also view the wide range of products available, who are the most popular sellers, reviews of customers and items that were viewed recently.You can get Amazon associate programme recommendation fees if you retail products of Amazon.com on your webstore.</p>
              </div>

              <div className={Style.ContentDiv}>
                <h4>Our Services</h4>
                <p>We possess years of experience in the field of helping ecommerce platforms and we are here to help you with designing and implementing of Amazon’s webstore.</p>
              </div>

              <div className={Style.ContentDiv}>
                <h4>We provide you with the following services as solution providers of Amazon’s webstore</h4>
                <ul className={Style.TwoCol}>
                  <li>Promotion Strategy of E-commerce</li>
                  <li>Creation of logo and branding</li>
                  <li>Management of the order</li>
                  <li>Webstore on Facebook</li>
                  <li>Management of content</li>
                  <li>Reporting</li>
                  <li>Bifurcation of items</li>
