...
export const metadata = {
  ...
  twitter: {
    ...
    title: "WooCommerce Development Services | WooCommerce development Company",
    description:
      "Unlock the full potential of your e-commerce website with Tech2Globe’s expert WooCommerce development services. Optimize sales and user experience!"
  },
  alternates: {
...
export default function WoocommerceDevelopment() {
  return (
    ...
    <>
      ...
      <Breadcrumb parentName="Technologies" pageName="Woocommerce Development" />
      <BrandSection />
      <section className={Style.PageContent}>
        <div className="container">
          <div className="row">
            <div className="col-lg-9 col-md-9 col-sm-12 col-xs-12">
              <ServiceBanner pageName="Woocommerce Development" imageSrc="/images/services/cms-banner2.jpg" />
              ...
              <div className={Style.ContentDiv}>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <h5 className="text-danger">Maintenance and Security</h5>
