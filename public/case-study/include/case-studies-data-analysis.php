...
$csItems = $caseStudies["Data Analysis"];
?>
<link rel="stylesheet" href="./include/case-study-card.css">

<h2 class="text-center mt-5">More Case Studies on Data Analysis</h2>
<div class="row my-5 more-case-study-section">
    ...
    ?>
        <div class="col-md-4 col-sm-6 col-xs-12  mb-4">
            <div class="case-study-card">
                <div class="case-study-image d-flex justify-content-center align-items-center data-analysis">
    ...
    <?php if (count($filteredCaseStudies) > 3): ?>
        <div class="col-12 text-center mt-4">
            <a href="/case-studies/data-analysis"><button class="btn btn-danger">More Case Studies <i class="fa-solid fa-angles-right"></i></button></a>
        </div>
    <?php endif; ?>
</div>
